...
لـ عمل تذكرة !تذكرة
 لـ مسح الشات ّ !مسح [عدد الرسائل] 
لـ قفل التذكرة قم بكتابه "!قفل" وستقفل التذكرة بعد كتابة التاكيد
لـ معرفه معلومات الروم قم بكتابه "!ch" وستظهر لك معلومات الروم
**`);
    }
});    
client.on('message', message => {
